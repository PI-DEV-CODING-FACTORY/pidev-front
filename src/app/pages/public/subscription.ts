                            ...
                            <div class="col-span-12">
                                ...
                                <div class="flex align-items-center gap-3">
                                    <p-fileUpload
                                        #degreeUpload
                                        mode="basic"
                                        chooseLabel="Télécharger le Diplôme (PDF)"
                                        [maxFileSize]="1000000"
                                ...
                                <small class="text-600 block mt-2">Taille max: 1MB. Formats acceptés: PDF, Images</small>
                            </div>
                            ...
                            <div class="col-span-12">
                                ...
                                <div class="flex align-items-center gap-3">
                                    <p-fileUpload
                                        #notesUpload
                                        mode="basic"
                                        chooseLabel="Télécharger le Relevé (PDF)"
                                        [maxFileSize]="1000000"
                                        accept="application/pdf,image/*"
                                        [auto]="true"
