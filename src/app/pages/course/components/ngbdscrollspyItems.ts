...
@Component({
    ...
    standalone: true,
    imports: [NgbScrollSpyModule, FormsModule, CommonModule, NgbdAccordionToggle],
    template: `
            ...
            <div class="main-content">
                <div ngbScrollSpy #spy="ngbScrollSpy" [rootMargin]="'-100px'" class="content-section p-3 rounded-2">
                    <div *ngFor="let lesson of course?.lessons; let i = index" [id]="'lesson-' + i">
                        ...
                        <ngbd-accordion-toggle [courseId]="course?.id!" [lessonId]="lesson.id"> </ngbd-accordion-toggle>
                    </div>
                </div>
            </div>
